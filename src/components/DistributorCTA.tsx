  ...
  return (
    <section className="relative py-24 bg-gradient-to-tr from-primary-green via-primary-green to-secondary-green text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 text-center flex flex-col items-center">
        ...
        >
          Join our growing network of trusted partners delivering premium parboiled rice and agricultural by-products across major markets in Africa and beyond. We support your business with reliable volumes, premium product quality, and direct marketing assistance.
        </motion.p>
